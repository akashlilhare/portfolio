...
class Qualification{
  ...
  Qualification({required this.title, required this.subTitle, required this.date});

}

List<Qualification> qualificationList = [
  Qualification(title: "Software Engineer Intern", subTitle: "WinkWack", date: ["April 2021 - ","July 2021"]),
